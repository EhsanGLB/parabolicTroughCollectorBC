...
#include "parabolicTroughCollectorBC.H"
...
Foam::parabolicTroughCollectorBC::parabolicTroughCollectorBC
(
    const fvPatch& p,
...
Foam::parabolicTroughCollectorBC::parabolicTroughCollectorBC
(
    const parabolicTroughCollectorBC& ptf,
    const fvPatch& p,
    const DimensionedField<scalar, volMesh>& iF,
...
Foam::scalar Foam::parabolicTroughCollectorBC::LCRFunction(scalar teta)
{
////range coefficients
...
void Foam::parabolicTroughCollectorBC::updateCoeffs()
{
    if (updated())
    {
        return;
...
//// To calculate gradient
    ...
    forAll(degree_, i)
    {
        gradient()[i] = ( glassTrans_*tubeAbs_*IntRad_*LCRFunction(degree_[i]) - tubeGlassHeatTrans_/tubeOutArea_)/(kappaEffp[i]*rho_*Cp_);// 
    }
...
void Foam::parabolicTroughCollectorBC::write(Ostream& os) const
{
